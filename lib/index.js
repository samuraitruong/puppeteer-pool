    ...
    waitUntiEmpty() {
        return __awaiter(this, void 0, void 0, function* () {
            while (this.running > 0 || this.queue.length > 0) {
                console.log('Status Queue length : %d , running %d, browser initialized %d', this.queue.length, this.running, this.initialized.length);
                if (this.queue.length > 0) {
                    ...
                    yield new Promise((r) => setTimeout(r, this.options.jobDelay || 1000));
                }
            }
        });
    }
    ...
    getBrowser() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.initialized.length <= this.options.instanceCount) {
                const browser = yield puppeteer_1.default.launch(Object.assign({}, this.options));
                this.initialized.push(browser);
                return browser;
            }
            while (true) {
                yield new Promise((r) => setTimeout(r, this.options.pollingTime || 1000));
                if (this.pending.length > 0) {
                    const browser = this.pending.splice(0, 1)[0];
                    return browser;
                }
